# E-commerce Analytics Project (dbt + BigQuery + Tableau) + MCP Integration
...
### AI Component: Tableau Public MCP Integration
...
## Example prompts
"Get details for this Tableau Public workbook: <TABLEAU_PUBLIC_URL>"
"List the views available in this workbook: <TABLEAU_PUBLIC_URL>"
"Summarize the dashboards and likely business insights shown in this workbook: <TABLEAU_PUBLIC_URL>"

## Results:
A full documentation of the dashboard has been generated by Claude and inclueded in the repository.

## Details:
More details about the implementation in AI folder of the repository.
